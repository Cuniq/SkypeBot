...
/**
 * The Class TenMinutesReseter. This class will check every ten minutes if the value
 ...
 * @since 1.0
 */
public class TenMinutesReseter implements Reseter {

	/** The Constant TEN_MINUTES. */
	private static final short TEN_MINUTES = 600;
	 ...
	 *            the item
	 */
	public TenMinutesReseter(MutableInt item) {
		this.iItem = item;
		item = iItem;
	 ...
	 *            the item
	 */
	public TenMinutesReseter(MutableLong item) {
		this.lItem = item;
		item = lItem;
